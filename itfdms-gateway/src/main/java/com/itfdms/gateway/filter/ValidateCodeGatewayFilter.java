package com.itfdms.gateway.filter;
...
import com.itfdms.common.core.exception.ValidateCodeException;
import com.itfdms.common.core.util.Result;
import com.itfdms.common.core.util.WebUtils;
	...
	public GatewayFilter apply(Object config) {
		return (exchange, chain) -> {
			...
			try {
				...
				try {
					return response.writeWith(Mono.just(response.bufferFactory().wrap(objectMapper.writeValueAsBytes(
							Result.builder().msg(e.getMessage()).code(CommonConstants.FAIL).build()))));
